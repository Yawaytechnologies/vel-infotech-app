...
function AnimatedBackground() {
  ...
  return (
    <View className="absolute inset-0 overflow-hidden">
      <Animated.View
        style={blob1}
        className="absolute -top-16 -right-12 w-[260px] h-[260px] bg-blue-600 rounded-full"
      />
      <Animated.View
        style={blob2}
        className="absolute -bottom-20 -left-16 w-[320px] h-[320px] bg-indigo-500 rounded-full"
      />
...
const slides: Slide[] = [
  {
    ...
    subtitle:
      "Adaptive paths and bite-sized lessons crafted for how you learn best.",
  ...
  },
  {
    ...
    subtitle:
      "Get instant help from mentors. Ask, discuss, and learn—without friction.",
...
export default function Onboarding() {
  ...
  const next = () => {
    if (page < slides.length - 1) {
      ...
      // ✅ Go to /login (group name `(auth)` is not part of the URL)
  ...
  return (
    <View className="flex-1 bg-white">
      ...
      <View className="h-40 justify-center px-6">
        <Text className="text-blue-900 text-2xl font-extrabold">
          Vel Infotech
        </Text>
